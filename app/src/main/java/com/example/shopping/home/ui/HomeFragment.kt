package com.example.shopping.home.ui
...
import com.example.shopping.home.ui.adapter.AutoScrollableCarouselAdapter
import com.example.shopping.product.ui.CategoryActivity
import com.example.shopping.product.ui.SearchableActivity
import com.example.shopping.product.ui.adapter.CategoryListAdapter
import com.example.shopping.product.ui.adapter.RecentlyViewedListAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun setUpIndicators(size:Int) {
        ...
        for(i in indicators.indices){
            ...
            indicators[i].apply {
                this?.setImageDrawable(ContextCompat.getDrawable(requireContext(),
                    R.drawable.dot_default
                ))
