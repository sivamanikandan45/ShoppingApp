package com.example.shopping.address.ui
...
import com.example.shopping.address.enums.FormMode
import com.example.shopping.address.model.Address
import com.example.shopping.address.ui.viewmodel.AddressViewModel
import com.example.shopping.address.ui.viewmodel.DeliveryAddressViewModel
            ...
            if(validateInputs()){
                ...
                if(currentUserId!=null&&currentUserId!=-1){
                    if(addressViewModel.formMode== FormMode.CREATE){
                        val address=
                            Address(0,currentUserId,name,phone,pinCode,state,city,street, area)
                        saveAddress(address)
                    }
                    if(addressViewModel.formMode== FormMode.EDIT){
                        val id=addressViewModel.selectedAddress.value?.addressId!!
                        val address=
                            Address(id,currentUserId,name,phone,pinCode,state,city,street, area)
